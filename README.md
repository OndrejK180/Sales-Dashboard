...
![Product Analysis](02_product_profitability.png)
...
![Discount Deep Dive](03_discount_deep_dive.png)
...
![Business Insights](04_business_insights.png)
...
2. Open `Sales_Profitability_Dashboard.pbix` in **Power BI Desktop** (free download from Microsoft).
3. If prompted, point the data source to your own copy of the dataset.
